    ...
    <section className="relative h-screen w-full overflow-hidden">
      ...
      <div className="relative z-10 flex h-full items-center justify-center">
        <div className="text-center text-white px-4">
          {title && (
            <h1 className="font-playfair text-4xl md:text-6xl lg:text-7xl font-light mb-4 tracking-wide">{title}</h1>
          )}
          {subtitle && <p className="text-lg md:text-xl font-light tracking-wider opacity-90">{subtitle}</p>}
        </div>
      </div>
